...
Run these SQL queries in your database (Neon/psql):
CREATE TABLE users (
...
Challenges Faced
Making JWT cookies work in both local (HTTP) and production (HTTPS) environments.
Managing foreign key relationships between multiple tables in PostgreSQL.
Live App
